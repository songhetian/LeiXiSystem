...
-- AddForeignKey
ALTER TABLE `punch_sync_state` ADD CONSTRAINT `punch_sync_state_device_no_fkey` FOREIGN KEY (`device_no`) REFERENCES `punch_devices`(`device_no`) ON DELETE RESTRICT ON UPDATE CASCADE;
