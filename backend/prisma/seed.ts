...
async function main() {
  ...
  const permissions = [
    ...
    { name: '排班管理', code: 'schedule:manage', resource: 'schedule', action: 'manage', module: 'attendance', sortOrder: 14 },
    { name: '考勤记录', code: 'attendance:view', resource: 'attendance', action: 'view', module: 'attendance', sortOrder: 15 },
    { name: '假期管理', code: 'vacation:view', resource: 'vacation', action: 'view', module: 'vacation', sortOrder: 16 },
    { name: '假期维护', code: 'vacation:manage', resource: 'vacation', action: 'manage', module: 'vacation', sortOrder: 17 },
    { name: '报销管理', code: 'reimbursement:view', resource: 'reimbursement', action: 'view', module: 'reimbursement', sortOrder: 18 },
    { name: '报销审批', code: 'reimbursement:approve', resource: 'reimbursement', action: 'approve', module: 'reimbursement', sortOrder: 19 },
    { name: '审批管理', code: 'approval:view', resource: 'approval', action: 'view', module: 'approval', sortOrder: 20 },
    { name: '数据看板', code: 'dashboard:view', resource: 'dashboard', action: 'view', module: 'dashboard', sortOrder: 21 },
    { name: '工资条查看', code: 'payslip:view', resource: 'payslip', action: 'view', module: 'payroll', sortOrder: 22 },
    { name: '薪资管理', code: 'payroll:manage', resource: 'payroll', action: 'manage', module: 'payroll', sortOrder: 23 },
    { name: '打卡原始记录', code: 'attendance:checkin:view', resource: 'attendance_checkin', action: 'view', module: 'attendance', sortOrder: 24 },
    { name: '考勤核算', code: 'attendance:calculate', resource: 'attendance', action: 'calculate', module: 'attendance', sortOrder: 25 },
    { name: '考勤规则管理', code: 'attendance:manage', resource: 'attendance', action: 'manage', module: 'attendance', sortOrder: 26 },
    { name: '工资条全量查看', code: 'payroll:payslip:view-all', resource: 'payslip', action: 'view_all', module: 'payroll', sortOrder: 27 },
    { name: '个人工资条查看', code: 'payroll:payslip:view-self', resource: 'payslip', action: 'view_self', module: 'payroll', sortOrder: 28 },
    { name: '安全审计查看', code: 'security:audit:view', resource: 'system_log', action: 'view', module: 'security', sortOrder: 29 },
    { name: 'SSO应用管理', code: 'sso:manage', resource: 'sso_app', action: 'manage', module: 'sso', sortOrder: 30 },
    { name: '数据导入', code: 'data:import', resource: 'data_import', action: 'import', module: 'data', sortOrder: 31 },
    { name: '数据导出', code: 'data:export', resource: 'data_export', action: 'export', module: 'data', sortOrder: 32 },
    { name: '员工生命周期查看', code: 'lifecycle:view', resource: 'employee_lifecycle', action: 'view', module: 'personnel', sortOrder: 33 },
    { name: '员工生命周期管理', code: 'lifecycle:manage', resource: 'employee_lifecycle', action: 'manage', module: 'personnel', sortOrder: 34 },
    { name: '资产查看', code: 'asset:view', resource: 'asset', action: 'view', module: 'asset', sortOrder: 35 },
    { name: '资产管理', code: 'asset:manage', resource: 'asset', action: 'manage', module: 'asset', sortOrder: 36 },
    { name: '资产领用归还', code: 'asset:assign', resource: 'asset_assignment', action: 'assign', module: 'asset', sortOrder: 37 },
    { name: 'HR工单查看', code: 'helpdesk:view', resource: 'helpdesk_ticket', action: 'view', module: 'helpdesk', sortOrder: 38 },
    { name: 'HR工单处理', code: 'helpdesk:handle', resource: 'helpdesk_ticket', action: 'handle', module: 'helpdesk', sortOrder: 39 },
    { name: 'HR工单配置', code: 'helpdesk:manage', resource: 'helpdesk_category', action: 'manage', module: 'helpdesk', sortOrder: 40 },
    { name: '招聘查看', code: 'recruitment:view', resource: 'recruitment', action: 'view', module: 'recruitment', sortOrder: 41 },
    { name: '招聘管理', code: 'recruitment:manage', resource: 'recruitment', action: 'manage', module: 'recruitment', sortOrder: 42 },
    { name: '绩效查看', code: 'performance:view', resource: 'performance', action: 'view', module: 'performance', sortOrder: 43 },
    { name: '绩效管理', code: 'performance:manage', resource: 'performance', action: 'manage', module: 'performance', sortOrder: 44 },
    { name: '绩效评审', code: 'performance:review', resource: 'performance_review', action: 'review', module: 'performance', sortOrder: 45 },
    { name: '培训查看', code: 'training:view', resource: 'training', action: 'view', module: 'training', sortOrder: 46 },
    { name: '培训管理', code: 'training:manage', resource: 'training', action: 'manage', module: 'training', sortOrder: 47 },
  ]
