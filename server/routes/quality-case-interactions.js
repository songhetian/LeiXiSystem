...
module.exports = async function (fastify, opts) {
  ...
  // GET /api/quality/cases/my-collections - 获取我的收藏
  fastify.get('/api/quality/cases/my-collections', async (request, reply) => {
    ...
    try {
      const [cases] = await pool.query(
        `SELECT qc.*, u.real_name as creator_name, cc.created_at as collected_at
         FROM case_collections cc
         INNER JOIN quality_cases qc ON cc.case_id = qc.id
      ...
      const [countResult] = await pool.query(
        'SELECT COUNT(*) as total FROM case_collections WHERE user_id = ?',
        [user_id]
      );
