      ...
      <div className="mb-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-end flex-wrap">
            {/* Sorting - Only show when inside a folder */}
            ...
            {!currentFolderCategory && (
               <button
                 ...
                 className="px-3 py-1.5 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors shadow-sm font-medium"
               >
                 添加分类
               </button>
            )}
