...
const VideoMessage = ({ message, isSender, onReply, onForward, onCollect }) => {
  ...
  return (
    <div className={`flex ${containerClass}`}>
      <div className={`p-1 rounded-lg max-w-xs ${messageClass} relative`}>
        ...
        <video controls src={message.file_url} className="max-w-full h-auto rounded-lg"></video>
