...
-- 版本: 003
-- 日期: 2024-11-16
-- 描述: 为知识库系统添加完整的学习中心功能，包括学习任务、学习计划、学习统计等
-- ============================================
...
-- ============================================
-- 11. 创建学习文章记录表 (knowledge_article_learning_records)
-- ============================================
CREATE TABLE IF NOT EXISTS knowledge_article_learning_records (
  ...
  status ENUM('in_progress','completed','abandoned') NOT NULL DEFAULT 'in_progress' COMMENT '学习状态',
  completed_at DATETIME NULL COMMENT '完成时间',
  last_position TEXT COMMENT '最后学习位置',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
  FOREIGN KEY (article_id) REFERENCES knowledge_articles(id) ON DELETE CASCADE,
...
-- ============================================
-- 12. 创建学习计划记录表 (knowledge_learning_plan_records)
-- ============================================
...
SELECT '迁移脚本 003_add_learning_center_tables.sql 执行完成' AS message;
