...
ALTER TABLE knowledge_articles
ADD COLUMN avg_read_duration INT NOT NULL DEFAULT 0;

ALTER TABLE knowledge_articles
ADD COLUMN collect_count INT NOT NULL DEFAULT 0;
...
SELECT 'Migration script 003_add_learning_center_tables.sql executed successfully' AS message;
