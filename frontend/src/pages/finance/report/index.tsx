        ...
        {data && (
          <>
            ...
            <Row gutter={16} className="charts-row">
              <Col span={12}>
                <Card title="支出构成" className="chart-card">
                  <EChart option={expensePieOption} className="chart-container" />
                </Card>
              </Col>
              <Col span={12}>
                <Card title="部门支出对比" className="chart-card">
            ...
            <Row gutter={16} className="charts-row">
              <Col span={12}>
                <Card title="月度支出趋势" className="chart-card">
                  <EChart option={monthlyTrendOption} className="chart-container" />
                </Card>
              </Col>
              <Col span={12}>
                <Card title="部门人均支出" className="chart-card">
                  <EChart option={deptAvgExpenseOption} className="chart-container" />
                </Card>
              </Col>
            </Row>
