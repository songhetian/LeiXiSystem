...
function PositionPage() {
  ...
  return (
    <div className="position-page">
      <Card bordered={false} className="position-page__search-card">
        <Form layout="inline">
          <FormItem label="岗位名称">
            <Input
              className="position-page__search-input"
              placeholder="请输入岗位名称"
              value={searchText}
          ...
          <FormItem label="部门">
            <Select
              className="position-page__dept-select"
              placeholder="请选择部门"
              value={searchDept}
              onChange={(val) => {
                setSearchDept(val)
      ...
      <Card bordered={false}>
        <div className="position-page__table-header">
          <div>
            <span className="position-page__table-title">岗位列表</span>
            <Tag color="blue" className="position-page__total-tag">
      ...
      <Modal
        ...
        className="position-page__modal"
      >
